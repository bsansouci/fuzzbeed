...
if(el.getAttribute('rel:gt_label')&&el.getAttribute('rel:gt_label')=='partner'&&(14==10||14==15)){el.setAttribute('rel:gt_label','partner/'+buzz.username);}},'bf-name':function(el,name){var truncate=el.getAttribute("rel:bf_truncate");if(truncate){if(!isNaN(truncate)){var truncate=parseInt(truncate);if(name.length>truncate){var terminator=el.getAttribute("rel:bf_truncate_terminator");term_length=terminator?terminator.length:3;terminator=terminator?terminator:'&hellip;';var name_length=truncate-term_length;name=name.substring(0,name_length);var words=name.split(/\s+/);if(words[words.length-1].match(/&/)&&!words[words.length-1].match(/;$/)){words.pop();}
         ...
         "promotions" : [
            {
               ...
               "probability" : 0.0601527835147107,
               "active" : "1",
            ...
            },
            {
               ...
               "sub_buzz_id" : "0",
               "image_big" : "/static/2015-01/15/13/campaign_images/webdr01/how-disgusting-are-you-compared-to-everyone-else-2-30881-1421347218-12_big.jpg",
               "probability" : 0.0233466880321962,
               "active" : "1",
               "original_image_height" : "540",
               "height" : "83",
               "description" : "<b>Fess up, booger eaters.</b>",
            ...
            },
            {
               ...
               "campaign_id" : "3575142",
               "rate" : 0.00656569117949421,
               "impressions" : "145910",
               "image_id" : "124788",
               "original_image_width" : "640",
               "promoter" : "251155",
               "updated" : "2015-01-16 21:06:26",
               "id" : "175449",
               ...
               "probability" : 0.00164830977840938,
               "active" : "1",
            ...
            },
            {
               ...
               "probability" : 0.0135917194850142,
               "active" : "1",
               "original_image_height" : "480",
               "height" : "83",
               "description" : "<b>Fess up, booger eaters.</b>",
            ...
            },
            {
               ...
               "sub_buzz_id" : "0",
               "image_big" : "/static/2015-01/15/13/campaign_images/webdr01/how-disgusting-are-you-compared-to-everyone-else-2-30881-1421347221-15_big.jpg",
               "probability" : 0.0167446587400823,
               "active" : "1",
               "original_image_height" : "458",
               "height" : "83",
               "description" : "<b>Fess up, booger eaters.</b>",
            ...
            },
            {
               ...
               "sub_buzz_id" : "0",
               "image_big" : "/static/2015-01/15/13/campaign_images/webdr01/how-disgusting-are-you-compared-to-everyone-else-2-30881-1421347218-12_big.jpg",
               "probability" : 0.0229586353614664,
               "active" : "1",
               "original_image_height" : "540",
               "height" : "83",
               "description" : "<b>Fess up, booger eaters.</b>",
            ...
            },
            {
               ...
               "sub_buzz_id" : "0",
               "image_big" : "/static/2015-01/15/13/campaign_images/webdr01/how-disgusting-are-you-compared-to-everyone-else-2-30881-1421347221-15_big.jpg",
               "probability" : 0.00887195922883506,
               "active" : "1",
               "original_image_height" : "458",
               "height" : "83",
               "description" : "<b>Fess up, booger eaters.</b>",
         ...
         "promotions" : [
            {
               ...
               "campaign_id" : "3577565",
               "rate" : 0.00658089735229813,
               "impressions" : "1147108",
               "image_id" : "125013",
               "original_image_width" : "1024",
               "promoter" : "1026792",
               "updated" : "2015-01-16 21:06:36",
               "id" : "175896",
...
/* s 21:20:37 01/16/2015 */
/* g 21:28:13 01/16/2015 - sl=143 */ 